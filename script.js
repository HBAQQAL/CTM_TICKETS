...
start = () => {
  fetch(
    "https://booking.ctm.ma/api/fr-fr/journeys/search?departureDate=2023-12-15&isPartOfRoundtrip=false&currency=CURRENCY.MAD&fareClasses=BONUS_SCHEME_GROUP.ADULT%2C1&originBusStopId=362&destinationCityId=5611&IsOutbound=true&CheckPaxSoldTogetherRules=true"
  )
    ...
    .then((data) => {
      ...
      data.Journeys.forEach(function (journey) {
        ...
        if (journey.CampaignPrice != null && journey.CampaignPrice < 200) {
          sendMail(journey);
